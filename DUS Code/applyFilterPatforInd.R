applyFilterPatforInd <- function(data,cov_ind){
       ...
       if(cov_ind == "neutropenia") {filtered_data <- data %>% filter(outcome_cohort_name %in% c("piperacillin_tazobactam","meropenem","ceftriaxone")) 
                                                           ...
                                                           "meropenem","cefotaxime","ceftriaxone","amoxicillin_clavulanate","penicillin_v")) 
       ...
       } else if(cov_ind ==  "gynecologic_surgery") {filtered_data <- data %>% filter(outcome_cohort_name %in% c("cefuroxime","meropenem",
       ...
       } else if(cov_ind ==  "urogenital_surgery") {filtered_data <- data %>% filter(outcome_cohort_name %in% c("meropenem","cefotaxime","ceftriaxone")) 
       } else if(cov_ind ==  "prostatic_surgery") {filtered_data <- data %>% filter(outcome_cohort_name %in% c("cefotaxime","ceftriaxone")) 
                                                              ...
                                                              "amoxicillin","penicillin_v","azithromycin")) 
                                                                ...
                                                                "amoxicillin")) 
       } else if(cov_ind ==  "cystitis") {filtered_data <- data %>% filter(outcome_cohort_name %in% c("cefuroxime","meropenem","cefotaxime","ceftriaxone","amoxicillin_clavulanate","azithromycin",
                                                          "amoxicillin","ceftozolane_tazobactam")) 
                                                            ...
                                                            "amoxicillin","ceftozolane_tazobactam")) 
       } else if(cov_ind ==  "bacteriuria") {filtered_data <- data %>% filter(outcome_cohort_name %in% c("cefuroxime","meropenem","cefotaxime","ceftriaxone","amoxicillin_clavulanate","azithromycin",
                                                             "amoxicillin","ceftozolane_tazobactam")) 
       ...
       } else if(cov_ind ==  "cellulitis") {filtered_data <- data %>% filter(outcome_cohort_name %in% c("tigecycline","piperacillin_tazobactam","cefuroxime","amoxicillin_clavulanate","clarithromycin","azithromycin",
                                                            "meropenem","cefotaxime","ceftriaxone","ceftriaxone","penicillin_g","penicillin_v")) 
       } else if(cov_ind ==  "erysipelas") {filtered_data <- data %>% filter(outcome_cohort_name %in% c("tigecycline","piperacillin_tazobactam","cefuroxime","amoxicillin_clavulanate","clarithromycin","azithromycin",
                                                            "meropenem","cefotaxime","ceftriaxone","ceftriaxone","penicillin_g","penicillin_v")) 
       } else if(cov_ind ==  "wound_infection") {filtered_data <- data %>% filter(outcome_cohort_name %in% c("tigecycline","piperacillin_tazobactam","cefuroxime","amoxicillin_clavulanate","clarithromycin","azithromycin",
                                                                "meropenem","cefotaxime","ceftriaxone","ceftriaxone","penicillin_g","penicillin_v")) 
       ...
       } else if(cov_ind ==  "implant") {filtered_data <- data %>% filter(outcome_cohort_name %in% c("belatacept","cyclosporine","mycophenolic_acid" ,"sirolimus","tacrolimus_no_topical"  )) 
       } else if(cov_ind ==  "transplant") {filtered_data <- data %>% filter(outcome_cohort_name %in% c("belatacept","cyclosporine", "mycophenolic_acid" ,"sirolimus","tacrolimus_no_topical" )) 
       ...
       } else if(cov_ind ==  "smoking") {filtered_data <- data %>% filter(outcome_cohort_name %in% c("nicotine","varenicline")) 
                                                     ...
                                                     "upadacitinib", "golimumab","sarilumab","baricitinib","anakinra")) 
       } else if(cov_ind ==  "pcv") {filtered_data <- data %>% filter(outcome_cohort_name %in% c( "verteporfin"  ,"bevacizumab" ,"ranibizumab" )) 
       } else if(cov_ind ==  "scs") {filtered_data <- data %>% filter(outcome_cohort_name %in% c("verteporfin"  ,"bevacizumab" ,"ranibizumab")) 
       } else if(cov_ind ==  "cnv") {filtered_data <- data %>% filter(outcome_cohort_name %in% c("verteporfin"  ,"bevacizumab" ,"ranibizumab")) 
       } else if(cov_ind ==  "exudative_amd") {filtered_data <- data %>% filter(outcome_cohort_name %in% c("verteporfin"  ,"bevacizumab" ,"ranibizumab")) 
       } else if(cov_ind ==  "catheter") {filtered_data <- data %>% filter(outcome_cohort_name %in% c("urokinase","alteplase","tenecteplase" , "streptokinase")) 
